                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: const IconButton(
                      icon: Icon(Icons.bookmark_outline, color: kLightColor),
                      onPressed: null,
                    ),
                  ),
                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'Dreamsville House',
                          style: kTextButtonMedium.copyWith(fontSize: 25),
                        ),
                      ),
                      ...
                      Padding(
                        ...
                        child: Text(
                          ...
                          style: kBodyMedium.copyWith(color: kLightColor, fontSize: 15),
                        ),
                      ),
